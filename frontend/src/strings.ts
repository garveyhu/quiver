...
export const STR = {
  ...
  // --- 档案库 DOM 浮层（书架热点 → React DOM 列表）---
  archiveOverlayTitle: '委托档案库',
  archiveOverlaySubtitle: '过往委托都装订在这书架上 — 搜索、筛选、点开看完整卷轴',
  archiveOverlayClose: '关闭',
  archiveOverlayCloseAria: '关闭档案库',
  archiveOverlaySearchPlaceholder: '搜索委托内容…',
  archiveOverlaySearchAria: '按委托内容搜索',
  archiveOverlaySearchClear: '清除搜索',
  archiveOverlayFilterStatusAll: '全部状态',
  archiveOverlayFilterProjectAll: '全部项目',
  archiveOverlayCountPrefix: '共 ',
  archiveOverlayCountSuffix: ' 卷',
  archiveOverlayEmpty: '书架空空 — 完成几次委托后，记录会装订上架。',
  archiveOverlayNoMatch: '没有符合条件的卷宗 — 换个筛选或搜索词试试。',
  archiveOverlayOpenTip: '点开这卷委托，展开完整卷轴',
  archiveOverlayCostUnknown: '花费未统计',
  archiveOverlayCostPrefix: '花费 $',
  archiveOverlayBranchPrefix: '分支 ',

  // --- 项目管理 DOM 浮层（门热点 → React DOM 增改删查）---
  projectsTitle: '工坊与项目',
  projectsSubtitle: '管理你的 git 仓库 — 添加、切换、改名、移除',
  projectsClose: '关闭',
  projectsCloseAria: '关闭项目管理',
  projectsAdd: '＋ 添加项目',
  projectsAddTip: '打开文件夹对话框，选一个 git 仓库',
  projectsEmpty: '还没有项目。点「添加项目」选一个 git 仓库当作工坊。',
  projectsCurrentBadge: '当前',
  projectsSelect: '设为当前',
  projectsSelectTip: '把这个项目设为当前工坊',
  projectsRename: '改名',
  projectsRenameTip: '给这个项目起一个显示名',
  projectsRemove: '移除',
  projectsRemoveTip: '从最近列表移除（不删仓库本身）',
  projectsRemoveConfirm: '确认从最近列表移除该项目？',
  projectsAliasPlaceholder: '显示名（留空＝用路径末段）',
  projectsAliasSave: '保存',
  projectsAliasCancel: '取消',
  projectsGitOk: 'git 仓库',
  projectsGitMissing: '路径不存在或非 git 仓库',
